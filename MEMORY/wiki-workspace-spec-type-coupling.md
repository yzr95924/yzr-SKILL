...
`llm-workspace-management/references/workspace-spec.md` §13 的 type 表"复用 wiki-spec §9"
...
**How to apply:** 改 `llm-wiki-management/references/wiki-spec.md` §9 type enum 或 §5 MEMORY
结构时，立刻 grep `llm-workspace-management/references/workspace-spec.md` 里的
