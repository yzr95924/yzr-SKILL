...
>
> 1. design.md §2.1 `Structure.S2 同义重述段`：整段换说法复述 §1 的背景，
>    与 §1.3 重复
> 2. design.md §3 `Logic.L3 结论与论据脱节`：选型结论说"方案 A 最优"，
>    但 §3.2 对比表里方案 B 延迟更低，结论与论据打架
> 3. design.md §4 `SSOT.X2 内容重复`：与参照的部署文档里权限说明
>    逐字重复，应删并指向 SSOT
>
> 要逐条过一遍，还是出一份报告存档？
...
> **1/3** — design.md §2.1 `Structure.S2 同义重述段`：整段复述 §1 背景，
> 建议删并保留 §1 那版。接受 / 改判 / 跳过？
