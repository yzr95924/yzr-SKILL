...
必读 `ref/catalog.md`（规则清单 + AI 腔指纹表 + 两个条件节：跨文档 SSOT 仅参照输入存在
时启用，指令文档按被审对象类型启用）。
...
>
> 1. design.md 2.1 节 `同义重述`：整段换说法复述 1 节的背景，
>    与 1.3 节重复
> 2. design.md 3 节 `结论与论据脱节`：选型结论说"方案 A 最优"，
...
> **1/3** — design.md 2.1 节 `同义重述`：整段复述 1 节背景，
