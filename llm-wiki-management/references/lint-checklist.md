...
- **0.18.0+ 边界**——`check_wiki_fixtures.py` 只扫「约定文件」（AGENTS.md /
  CLAUDE.md / .gitignore / wiki/index.md / wiki/log.md / wiki/tags.md /
  MEMORY/MEMORY.md / scripts/SCRIPTS.md / raw/external/.symlink-anchor.toml）的字节
  合规；语义合并走 §五由 LLM 判断——脚本不替代人
